...
class ConfigSeeder extends Seeder
{
    public function run(): void
    {
        $entries = [
            ...
            ['config_key' => 'logo_url',            'config_hook' => 'app',       'config_position' => 2,  'config_value' => '/images/logo.svg',             'value_type' => 'string', 'description' => 'URL du logo affiché dans la navbar',                                                     'protected' => 1],
            ['config_key' => 'background_url',      'config_hook' => 'app',       'config_position' => 3,  'config_value' => '/images/background.jpg',       'value_type' => 'string', 'description' => 'Image de fond de la page de connexion',                                                  'protected' => 1],
