...
class ConfigSeeder extends Seeder
{
    public function run(): void
    {
        $entries = [
            ...
            ['config_key' => 'rebuild_pdf_on_failure',            'config_hook' => 'dolibarr', 'config_position' => 4, 'config_value' => 'true',                         'value_type' => 'bool',   'description' => 'Régénérer le PDF via Dolibarr si le téléchargement d\'une commande, facture ou devis échoue',    'protected' => 1],
            ...
            ['config_key' => 'vat_field_enabled',                 'config_hook' => 'dolibarr', 'config_position' => 12, 'config_value' => 'true',                        'value_type' => 'bool',   'description' => 'Afficher le champ N° TVA intracommunautaire sur la page "Mon compte"',                       'protected' => 1],
