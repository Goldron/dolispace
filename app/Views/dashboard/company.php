...
<div class="mb-8 flex flex-col gap-y-3 sm:flex-row sm:items-center sm:justify-between">
    <div>
        ...
        <p class="mt-1 text-sm text-gray-500">Informations issues de notre CRM.</p>
    </div>
...
<?php if (empty($company)): ?>
    <div class="bg-white rounded-xl border border-gray-200 px-5 py-16 text-center">
        <p class="text-sm text-gray-400">Impossible de charger les informations de la société.</p>
    </div>
<?php else: ?>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-5 space-y-6">
            ...
            <div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        <p class="text-xs font-medium text-gray-600 mb-1">Nom commercial</p>
                    ...
                    <div>
                        <p class="text-xs font-medium text-gray-600 mb-1">Code client</p>
                        <p class="w-full rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-sm text-gray-900"><?= $val('code_client') ?: '—' ?></p>
                    </div>
                    <div>
                        <p class="text-xs font-medium text-gray-600 mb-1">Client depuis</p>
                    ...
                    <div>
                        <p class="text-xs font-medium text-gray-600 mb-1">Remise</p>
            ...
            <!-- Coordonnées -->
            <div>
                <p class="text-xs font-semibold text-gray-400 uppercase tracking-wide mb-3">Coordonnées</p>
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                    ...
                    <div>
                        <p class="text-xs font-medium text-gray-600 mb-1">Site web</p>
                    ...
                    <div>
                        <p class="text-xs font-medium text-gray-600 mb-1">Téléphone</p>
                    ...
                    <div>
                        <p class="text-xs font-medium text-gray-600 mb-1">Mobile</p>
            ...
            <!-- Adresse -->
            <div>
                <p class="text-xs font-semibold text-gray-400 uppercase tracking-wide mb-3">Adresse</p>
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="sm:col-span-2">
                        <p class="text-xs font-medium text-gray-600 mb-1">Adresse</p>
                    ...
                    <div>
                        <p class="text-xs font-medium text-gray-600 mb-1">Code postal</p>
                    ...
                    <div>
                        <p class="text-xs font-medium text-gray-600 mb-1">Ville</p>
                    ...
                    <div>
                        <p class="text-xs font-medium text-gray-600 mb-1">Pays</p>
            ...
            <!-- Fiscal -->
            <div>
                <p class="text-xs font-semibold text-gray-400 uppercase tracking-wide mb-3">Fiscal</p>
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        <p class="text-xs font-medium text-gray-600 mb-1">N° TVA intracommunautaire</p>
        ...
        <div class="relative flex min-h-full items-center justify-center p-4">
            <div class="relative w-full max-w-md bg-white rounded-xl shadow-lg border border-gray-200">
                ...
                <div class="flex items-center justify-between px-5 py-4 border-b border-gray-100">
                    <h3 class="text-sm font-semibold text-gray-900">Modifier le N° TVA</h3>
                ...
                <div id="tva-step-input" class="p-5 space-y-4">
                    <div>
                        <label class="block text-xs font-medium text-gray-600 mb-1">N° TVA intracommunautaire</label>
                    ...
                    <div class="flex justify-end gap-x-2">
                        <button type="button" id="modal-tva-cancel" class="py-2 px-3 text-sm font-medium rounded-lg text-gray-600 hover:bg-gray-100 transition">Annuler</button>
                        <button type="button" id="btn-tva-verify"
                            ...
                            <span id="tva-verify-label">Vérifier</span>
                ...
                <div id="tva-step-confirm" class="hidden p-5 space-y-4">
                    <div class="flex items-start gap-x-3 rounded-lg border border-green-200 bg-green-50 p-4 text-sm text-green-700">
                        ...
                        <span>N° TVA valide selon le registre VIES.</span>
                    </div>
                    ...
                    <p class="text-xs text-gray-400">Voulez-vous enregistrer ce numéro de TVA ?</p>
                    <form action="<?= site_url('dashboard/company/update-tva') ?>" method="POST" id="form-tva-confirm">
                        ...
                        <div class="flex flex-col sm:flex-row justify-end gap-x-2 gap-y-2">
                            <button type="button" id="btn-tva-back" class="py-2 px-3 text-sm font-medium rounded-lg text-gray-600 hover:bg-gray-100 transition">Retour</button>
                            ...
                            <button type="submit" id="btn-tva-confirm-name"
                                ...
                                Confirmer et mettre à jour le nom
                            </button>
                        </div>
                    </form>
                </div>
    ...
    <script>
        ...
        function setVerifyLoading(loading) {
            ...
            tvaVerifyLabel.textContent = loading ? 'Vérification…' : 'Vérifier';
        ...
        document.getElementById('btn-tva-verify').addEventListener('click', async () => {
            ...
            if (! tva) {
                showTvaError('Veuillez saisir un numéro de TVA.');
                return;
            }
            ...
            try {
                ...
                showTvaError('Erreur réseau. Veuillez réessayer.');
            }
